                ...
                <div class="panel-body">
                    <form action="/videos/{{ $video->uid }}" method="post">
                        ...
                        <div class="form-group{{ $errors->has('title') ? 'has-error' : '' }}">
                            ...
                            <input type="text" name="title" id=""title value="{{ old('title') ? old('title') : $video->title }}" class="form-control">
                        ...
                        <div class="form-group{{ $errors->has('description') ? 'has-error' : '' }}">
                            ...
                            <textarea class="form-control" name="description" id="description">{{ old('description') ? old('description') : $video->description }}</textarea>
